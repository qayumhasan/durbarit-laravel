...
class FrontendController extends ApiController
{
    ...
    public function index()
    {
        ...
        $strengthtop = Strength::limit(3)->get();
        $strengthbottom = Strength::skip(3)->take('3')->get();


        return view('frontend.home.index', compact('slider', 'aboutus', 'whyschochus', 'teatimonial', 'categores', 'projects', 'video', 'services','header','strengthtop','strengthbottom'));
    }
