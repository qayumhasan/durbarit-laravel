	    ...
	    <ul class="metismenu" id="menu1">
	      ...
	      <li class="single-nav-wrapper">
	        ...
	        <ul class="dashboard-menu">
	          ...
	          <li><a>Invoice Create</a></li>
	          <li><a>Invoice List</a></li>
	          <li><a>Invoice Setting</a></li>
	        </ul>
	      </li>
	      ...
	      <li class="single-nav-wrapper">
	        ...
	        <ul class="dashboard-menu">
	          ...
	          <li><a>Staff Attendance</a></li>
	          <li><a>Staff Attendance Reports</a></li>
	          <li><a>Payroll </a></li>
	      ...
	      <li class="single-nav-wrapper">
	        ...
	        <ul class="dashboard-menu">
	          ...
	          <li><a>Payment Method Settings</a></li>
	          <li><a>Holiday</a></li>
