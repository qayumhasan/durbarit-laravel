...
<div class="content_wrapper">
            <div class="middle_content_wrapper" style="margin-bottom: 5%;">
                ...
                <div class="nb_button">
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <div class="nb_m">
                            <a href="{{route('customar.invoice.download',$order->order_id)}}">Print</a>
                                <a href="{{route('customar.invoice.download',$order->order_id)}}">Download</a>
                            </div>
                        </div>
                    </div>
                </div>
