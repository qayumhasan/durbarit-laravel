    ...
    <div class="container">
        ...
        <div class="sripe_payment">
            ...
            <div class="payment-form">
                ...
                <form action="{{ route('payment.stripe.submit') }}" class="stripe_form" method="POST" id="payment-form">
                    @csrf
                    ...
                    <div class="hidden_field">
                        <input type="hidden" name="total" value="{{ $billing->total}}">
                        <input type="hidden" name="qty" value="{{ $billing->qty }}">
                        <input type="hidden" name="invoice_no" value="{{ $billing->order_id }}">
                        <input type="hidden" name="user_id" value="{{ $billing->user_id }}">
                        <input type="hidden" name="paid_time" value="{{ $billing->created_at }}">
                        <input type="hidden" name="billing_id" value="{{ $billing->id }}">
                    </div>
                    <button class="btn btn-sm btn-success payment-button pull-right" type="submit">Pay ({{ $billing->total}})</button>
                </form>
            </div>
        </div>
    </div>
