             ...
             <div class="col-sm-12 wow animate__animated animate__fadeIn animate__delay-1s">
                <div class="login-wrap" style="min-height: 400px;">
                    <div class="login-html">
                        <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Enter Your Phone Number</label>
                        <input  id="tab-" type="radio" name="tab" class="sign-up d-none"><label for="tab-2" class="tab"></label>
                        <div class="login-form">
                            <form action="{{route('customar.forgot.phone.submit')}}" method="post">
                                @csrf
                            <div class="sign-in-htm">
                                <div class="group">
                                    
                                    <input  type="phone" name="phone" class="input">
                                    @error('phone')
